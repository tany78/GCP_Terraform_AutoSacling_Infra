...
variable "ssh_source_ranges" {
  ...
  type        = list(string)
  default     = ["<Put Your Own Source Public IP"]
}
...
# Enable this to create Bootstrap Bucket
...
variable "panorama_ssh_keys" {
  ...
  type        = string
  default     = "<Replace with your own SSH Key>"
  }
...
variable "vm_auth_key" {
  ...
  type        = string
  default     = "<Replace with your own Key from Panorama>"
}

variable "auth_key" {
  description = "Panorama Licensing plugin key for VM-Series (metadata key: auth-key)"
  type        = string
  default     = "<Replace with your own Key from Panorama Licensing Plugin>"
}

#variable "authcodes" {
#  description = "BYOL licensing auth codes (comma-separated) (metadata key: authcodes)"
#  type        = string
#  default     = "<Replace with your own Key from CSP>"
#}
...
variable "vmseries_pin_id" {
  ...
  type        = string
  default     = "<Replace with your own PIN from CSP>"
}
